...
-- skeleton key
minetest.register_craftitem("chest:skeleton_key", {
    description = S("Skeleton Key"),
    inventory_image = "chest_key_skeleton.png",
    on_use = function(itemstack, user, pointed_thing)
        ...
        if secret then
            ...
            local new_stack = ItemStack("chest:key")
...
minetest.register_craft({
    type = "cooking",
    output = "gold:ingot",
    recipe = "chest:skeleton_key",
    cooktime = 5,
})

-- key
minetest.register_tool("chest:key", {
    description = S("Key"),
