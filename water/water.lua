...
minetest.register_node("water:river_source", {
	description = S("River Water Source"),
	drawtype = "liquid",
	tiles = {
		{
			name = "water_river_source_animated.png",
			backface_culling = false,
			animation = {
				type = "vertical_frames",
				aspect_w = 16,
	...
	drowning = 1,
	liquidtype = "source",
	liquid_alternative_flowing = "water:river_flowing",
	liquid_alternative_source = "water:river_source",
	liquid_viscosity = 1,
...
minetest.register_node("water:river_flowing", {
	description = S("Flowing River Water"),
	drawtype = "flowingliquid",
	tiles = {"water_river.png"},
	special_tiles = {
		{
			name = "water_river_flowing_animated.png",
			backface_culling = false,
			animation = {
				type = "vertical_frames",
				aspect_w = 16,
